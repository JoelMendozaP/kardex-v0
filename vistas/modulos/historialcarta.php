<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      <b> HISTORIAL DE LA CARTA INTERNA</b> 
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="corespinterna"><i class="fa fa-dashboard"></i> VOLVER </a></li>
...
include("conexionmysqli.php");
      if (isset($_GET["idcartahitorial"])) {
        
        $id = $_GET["idcartahitorial"];
        $idusu= $_GET["codu"];

        

        $query = "SELECT * FROM carta c,recibe r , usuarios u  WHERE c.cod_carta =$id and r.cod_carta = $id and u.cod_user = $idusu ";
    ...
    <div class="box bg-gray disabled" >
      <?php
       echo '<button class="btn btn-danger btn-lg btnimplistam" codcartahistorial="'.$id.'"> <i class="fa fa-print"> GENERAR PDF</i>
        </button>'?>
        <br>
      </div>
      ...
      echo ' <div class="row   icono-nosotros">
        <div class="col-md-3 col-sm-6 col-xs-12 ">
          <div class="info-box">
            <span class="info-box-icon bg-black-active"><i class="fa fa-institution"></i></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 ">
          <div class="info-box">
            <span class="info-box-icon bg-purple-active"><i class="fa fa-balance-scale"></i></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 ">
          <div class="info-box">
            <span class="info-box-icon bg-red-active"><i class="fa fa-check-circle"></i></span>
